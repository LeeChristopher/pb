...
func (x *CliBaseRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CliBaseRsp) ProtoMessage() {}

func (x *CliBaseRsp) ProtoReflect() protoreflect.Message {
	mi := &file_base_base_proto_msgTypes[0]
...
// Deprecated: Use CliBaseRsp.ProtoReflect.Descriptor instead.
func (*CliBaseRsp) Descriptor() ([]byte, []int) {
	return file_base_base_proto_rawDescGZIP(), []int{0}
}

func (x *CliBaseRsp) GetCode() uint64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CliBaseRsp) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *CliBaseRsp) GetRuntime() float64 {
	if x != nil {
		return x.Runtime
	}
	return 0
...
var file_base_base_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x62, 0x61, 0x73, 0x65, 0x22, 0x54, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x42, 0x61,
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x07, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x23, 0x5a,
	0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4c, 0x65, 0x65, 0x43,
	0x68, 0x72, 0x69, 0x73, 0x74, 0x6f, 0x70, 0x68, 0x65, 0x72, 0x2f, 0x70, 0x62, 0x2f, 0x62, 0x61,
...
var file_base_base_proto_goTypes = []interface{}{
	(*CliBaseRsp)(nil), // 0: base.CliBaseRsp
}
